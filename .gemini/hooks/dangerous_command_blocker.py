#!/usr/bin/env python3
"""
Gemini CLI Hook: Dangerous Command Blocker
===========================================
BeforeTool hook that blocks dangerous system commands before execution.
...
- Exit 2: Block execution and show stderr message
"""
...
def get_project_root() -> Path:
    ...
    # Fallback to script's grandparent (assumes .gemini/hooks/ structure)
...
def main():
    ...
    # Gemini CLI uses "tool_name" same as Claude Code
    tool_name = input_data.get("tool_name", "")
    
    # Check for shell/bash tool invocations
    # Gemini CLI may use different tool names, check common ones
    ...
    if is_dangerous:
        print(f"⛔ BLOCKED: This command has been blocked by the Gemini security hook.", file=sys.stderr)
